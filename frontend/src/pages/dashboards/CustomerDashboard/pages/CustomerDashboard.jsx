...
const sampleCarouselEvents = [
  { id: 1, title: 'Comedy Night Live', location: 'Mumbai', date: '2023-10-25T00:00:00', genre: 'Satire', image: img_big },
  { id: 2, title: 'Stand-up Premier League', location: 'Delhi', date: '2023-10-28T00:00:00', genre: 'Observational Comedy', image: img_big2 },
  { id: 3, title: 'Laugh Riot Festival', location: 'Bangalore', date: '2023-11-02T00:00:00', genre: 'Improvisational', image: img_big3 }
];
const sampleFeaturedEvents = [
  { id: 1, title: 'Satire Special', comedian: 'Vir Das', price: '₹499', date: '2023-10-25T00:00:00', venue: 'Comedy Cube', genre: 'Satire', image: img_big },
  { id: 2, title: 'Roast Battle', comedian: 'Kaneez Surka', price: '₹699', date: '2023-10-28T00:00:00', venue: 'Laugh Factory', genre: 'Roast Battles', image: img_big2 },
  { id: 3, title: 'Improv Jam', comedian: 'Kenny Sebastian', price: '₹399', date: '2023-11-02T00:00:00', venue: 'Funny Bone', genre: 'Improvisational', image: img_big3 }
];
const sampleNearYouEvents = [
  { id: 1, title: 'Local Laughs', location: 'Mumbai', date: '2023-10-26T00:00:00', price: '₹299', genre: 'Sketch Comedy', image: img_big },
  { id: 2, title: 'Neighborhood Giggle', location: 'Pune', date: '2023-10-27T00:00:00', price: '₹399', genre: 'Musical Comedy', image: img_big2 },
  { id: 3, title: 'Hometown Humor', location: 'Bangalore', date: '2023-10-28T00:00:00', price: '₹499', genre: 'Dark Comedy', image: img_big3 }
];
const genres = [
